    ...
    def _tf_simple_save(self, itr=None):
        ...
        if proc_id()==0:
            ...
            if osp.exists(fpath):
                ...
                shutil.rmtree(fpath)
            tf.saved_model.simple_save(session=self.tf_saver_elements["session"], export_dir=fpath, inputs=self.tf_saver_elements["inputs"], outputs=self.tf_saver_elements["outputs"])
